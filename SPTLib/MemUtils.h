...
#endif
inline bool GetModuleInfo(const std::string& moduleName, void** moduleHandle, void** moduleBase, size_t* moduleSize)
{
#ifdef WIN32
	...
	return ret;
#else
	PL_GetModuleInfo(moduleName, *moduleHandle, moduleBase, moduleSize);
